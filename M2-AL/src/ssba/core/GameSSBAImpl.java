 ...
 */
public class GameSSBAImpl implements Game, Observer {
	...
	private GameLevelSSBAImpl currentPlayedLevel = null;
	protected int levelNumber;
	protected ArrayList<GameLevel> gameLevels;

	protected Label resultText, scoreText;
	protected Label information;
	protected Label informationValue;
	protected Label resultValue, scoreValue;
	...
	public GameSSBAImpl() {
		...
		resultText = new Label("In Progress:");
	...
	private Container createStatusBar() {
		...
		c.setLayout(layout);
		resultValue = new Label(Integer.toString(life[0].getValue()));
	...
	public void start() {
		...
		for (GameLevel level : gameLevels) {
			...
			try {
				...
				currentPlayedLevel = (GameLevelSSBAImpl) level;
				levelNumber++;
		...
		if (o == endOfGame) {
			...
			for (ObservableValue<Integer> lifeObservable : life) {
				if (o == lifeObservable) {
					...
					resultValue.setText(Integer.toString(lives));
					if (lives == 0) {
